...
import com.huew.utilities.Utilities;
...
public class Listener extends Base implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		String file = "C:\\Users\\thakur\\screenshot"+"\\"+"screenshot"+(new Random().nextInt())+".png";

		try {
			Utilities.takeSnapShot(driver, file);
		} catch (Exception e) {
	...
	public void onStart(ITestContext context) {
		...
		try {
			...
			String pdfile = thepdffile;
			PdfWriter.getInstance(this.document, new FileOutputStream(pdfile));
		} catch (Exception e) {
			e.printStackTrace();
		}
		this.document.open();
